    ...
    <footer className="relative py-16 md:py-24 overflow-hidden bg-gradient-to-b from-background to-sea-deep/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-16 w-full px-4">
          <motion.div
            className="relative overflow-hidden bg-[#FAF6F0] border border-[#EBE3D5] rounded-[2rem] p-8 md:p-10 w-full max-w-2xl shadow-sm text-left font-sans"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
          >
            ...
            <div className="absolute -top-10 -right-10 w-40 h-40 md:w-48 md:h-48 rounded-full bg-[#FCE5CD] opacity-60 pointer-events-none" />
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-semibold text-[#2B1B17] mt-2 font-serif">
                Ganesh Jamadar
              </h3>
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#F4EFE6] flex items-center justify-center text-[#2F5233] shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-graduation-cap"><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z"/><path d="M6 18.8v-4L2 13"/><path d="M21.42 10.922V17a2 2 0 0 1-2 2h-2.582a2 2 0 0 1-1.879-1.318l-1.025-3.076"/></svg>
                </div>
                <div>
                  <span className="text-[10px] font-bold tracking-wider text-[#8D7E73] uppercase block">
                    BRANCH
                  </span>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#F4EFE6] flex items-center justify-center text-[#2F5233] shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-hash"><line x1="4" x2="20" y1="9" y2="9"/><line x1="4" x2="20" y1="15" y2="15"/><line x1="10" x2="8" y1="3" y2="21"/><line x1="16" x2="14" y1="3" y2="21"/></svg>
                </div>
                <div>
                  <span className="text-[10px] font-bold tracking-wider text-[#8D7E73] uppercase block">
                    BATCH
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#F4EFE6] flex items-center justify-center text-[#2F5233] shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-code-xml"><path d="m18 16 4-4-4-4"/><path d="m6 8-4 4 4 4"/><path d="m14.5 4-5 16"/></svg>
                </div>
                <div>
                  <span className="text-[10px] font-bold tracking-wider text-[#8D7E73] uppercase block">
                    ROLE
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-sm font-semibold text-[#2B1B17] leading-tight block">
                    Frontend, backend, and the pixels too.
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* Divider */}
            <div className="relative z-10 border-t border-[#EBE3D5] my-6" />
            ...
            <div className="relative z-10 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <a
                  ...
                  className="border border-[#E7AC6F] text-[#2F5233] rounded-full py-2.5 px-6 flex items-center justify-center gap-2 hover:bg-[#FCE5CD]/40 transition-all font-medium text-sm text-center"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border border-[#EBE3D5] text-[#7D6E65] rounded-full py-2.5 px-6 flex items-center justify-center gap-2 hover:bg-[#F4EFE6] transition-all font-medium text-sm text-center"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full border border-[#EBE3D5] text-[#7D6E65] rounded-full py-2.5 px-6 flex items-center justify-center gap-2 hover:bg-[#F4EFE6] transition-all font-medium text-sm text-center"
              >
