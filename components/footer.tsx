      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-[#FAF6F0] border border-[#EBE3D5] text-[#2F5233] hover:text-[#2B1B17] hover:bg-[#F4EFE6] transition-all font-medium text-sm shadow-sm cursor-pointer"
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
          >
            <span className="w-6 h-6 rounded-full bg-[#F4EFE6] flex items-center justify-center font-serif text-xs font-bold text-[#2F5233]">GJ</span>
            Meet the Developer
          </motion.button>
        </motion.div>
